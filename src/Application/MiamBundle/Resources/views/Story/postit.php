<div class="story story_object story_<?php echo $story->getId() ?> story_domain_<?php echo $story->getDomain() ?>" rel="story_<?php echo $story->getId() ?>" data-story-id="<?php echo $story->getId() ?>" data-story-points="<?php echo $story->getPoints() ?>">
