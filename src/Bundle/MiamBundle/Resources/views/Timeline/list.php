<ol class="timeline">
    ...
    <li class="tentry<?php !$index && print ' first' ?>" id="tentry_<?php echo $entry->getId() ?>">
        <img src="<?php echo Bundle\GravatarBundle\Api::getUrl($emails[$entry->getUser()->getUsername()]) ?>" />
        <?php echo strtr(
